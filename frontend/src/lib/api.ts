...
export const endpoints = {
  ...
  applicationsBulkEmail: `${API_PREFIX}/applications/bulk-email/`,
  applicationEmailPreview: (id: string) => `${API_PREFIX}/applications/${id}/email/preview/`,
  emailConfig: `${API_PREFIX}/email/`,
  emailTemplates: `${API_PREFIX}/email/templates/`,
  emailTemplate: (id: string) => `${API_PREFIX}/email/templates/${id}/`,
  emailTemplatesGenerate: `${API_PREFIX}/email/templates/generate/`,
  calls: `${API_PREFIX}/calls/`,
  call: (id: string) => `${API_PREFIX}/calls/${id}/`,
  callAction: (id: string, action: string) => `${API_PREFIX}/calls/${id}/${action}/`,
  callsConfig: `${API_PREFIX}/calls/config/`,
  applicationsBulkCalls: `${API_PREFIX}/applications/bulk-calls/`,
  candidates: `${API_PREFIX}/candidates/`,
  candidate: (id: string) => `${API_PREFIX}/candidates/${id}/`,
  candidateResumeLink: (id: string) => `${API_PREFIX}/candidates/${id}/resume-link/`,
  resumeUploads: `${API_PREFIX}/resumes/uploads/`,
  resumeUploadBatch: (id: string) => `${API_PREFIX}/resumes/uploads/${id}/`,
