...
export const HOME_SPEC = {
  ...
  /** High-level users with Mine off: keep JDs raised by users of these roles. */
  level: param.list<string>([]),
...
export const HOME_CLEARED = { q: '', status: [] as string[], level: [] as string[], page: 1 }
