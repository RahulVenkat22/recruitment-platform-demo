...
STATUS_COLORS: dict[str, ColorPair] = {
    ...
    ApplicationStatus.OFFER_SENT: ColorPair("#FBF1DC", "#B7791F", "amber"),
    ApplicationStatus.OFFER_ACCEPTED: ColorPair("#DCF5E3", "#15803D", "green"),
...
CATEGORY_COLORS: dict[str, ColorPair] = {
    ...
    ActivityCategory.OFFER: ColorPair("#FBF1DC", "#B7791F", "amber"),
